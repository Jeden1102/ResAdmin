          ...
          <b-button @click="toggleWaiter" v-b-toggle.collapse-1 variant="primary" class="btn">
            ...
            <b-collapse id="collapse-1" class="mt-2">
                <b-card class="links">
                    ...
                    <p><router-link :class="[navOpen ? 'link' : 'link2']" to="#"><img class="icon" src="@/assets/website.png" alt=""> <span v-if="navOpen">Restaurant</span></router-link></p>
          ...
          <b-button @click="toggleMenager" v-b-toggle.collapse-2 variant="primary" class="btn">
            ...
            <b-collapse id="collapse-2" class="mt-2">
                <b-card class="links">
                    ...
                    <p><router-link :class="[navOpen ? 'link' : 'link2']" to="#"><img class="icon" src="@/assets/menu.png" alt=""> <span v-if="navOpen">Menu</span></router-link></p>
                    ...
                    <p><router-link :class="[navOpen ? 'link' : 'link2']" to="#"><img class="icon" src="@/assets/view.png" alt=""> <span v-if="navOpen">Edit view</span></router-link></p>
